...
SECRET_KEY = 'django-insecure-up8&281+j#o6fy#z^3o-u7q3z+1+u7)_%867ds#@n+sq26qkx_'
...
MEDIA_URL = '/media/'
MEDIA_ROOT = os.path.join(BASE_DIR, 'userUploadedFile') 
...
# Adding custom name in django messeages framework
MESSAGE_TAGS = {
